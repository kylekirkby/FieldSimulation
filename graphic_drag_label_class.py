...
class QDragLabel(QLabel):
    ...
    def mouseMoveEvent(self, event):
        #look for the left mouse button when it is used
        if event.buttons() == Qt.LeftButton:
            ...
            drag.setHotSpot(self.rect().topLeft()) #where to drag from
            drag_action = drag.start(Qt.MoveAction) #drag starts


class WheatDragLabel(QDragLabel):
    """This class provides a wheat label that can bre dragged and dropped"""
    def __init__(self):
        super().__init__(QPixmap(":/wheat_seed.png"))
        self.mimetext = "application/x-wheat"
                       
class PotatoDragLabel(QDragLabel):
    """This class provides a potato label that can bre dragged and dropped"""
    def __init__(self):
...
class CowDragLabel(QDragLabel):
    """This class provides a cow label that can bre dragged and dropped"""
    def __init__(self):
        super().__init__(QPixmap(":/cow_baby.png"))
                       
        self.mimetext = "application/x-cow"
class SheepDragLabel(QDragLabel):
    """This class provides a sheep label that can bre dragged and dropped"""
    def __init__(self):
